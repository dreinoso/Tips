...
#define declare_list_type(type, listName) type* listName
#define init_list(type, listName, list) struct listName* list = (struct listName*) malloc (sizeof(struct listName));
#define addToList(type, listName, list, elem) malloc (sizeof(type))
